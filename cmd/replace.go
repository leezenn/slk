...
func newReplaceCommand(deps Dependencies, rootOptions *rootOptions, prefix string, formatting ...textformat.Module) *cobra.Command {
...
the exact permalink and complete replacement text before invoking it.` + formattingHelp(formatting, "The --text value"),
	...
	command.RunE = func(cmd *cobra.Command, args []string) error {
		...
		return runReplace(cmd, rootOptions, client, target, options.text, prefix, formatting...)
	}
	return command
}

func runReplace(cmd *cobra.Command, rootOptions *rootOptions, client replaceClient, target messageMutationTarget, text, prefix string, modules ...textformat.Module) error {
